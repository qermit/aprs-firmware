 ...
 * Port direction
 */
typedef enum {INPUT = 0, OUTPUT = 1} portDirection_t;
...
typedef enum { LOW = 0 , HIGH = !LOW } logicalState_t;

/**
 *  charging status
 */

typedef enum { NOT_CHARGING = 0, CHARGING =! NOT_CHARGING } chargingStatus_t;

/**
 * 	Edge type
 */

typedef enum { RISING_EDGE = 0, FALLING_EDGE = 1 } edgeState_t;
